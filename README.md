<div align="center">
    <img src="https://tech4allcloud.com/files/logo.png" height="128">
    <h2>Tech4All Standard POS</h2>
</div>

#### An open-source Point of Sale for [Tech4All](https://github.com/frappe/erpnext) using [Vue.js](https://github.com/vuejs/vue) and [Vuetify](https://github.com/vuetifyjs/vuetify)
...
One-click installing available if you are hosting on FC from [here](https://tech4allcloud.com/marketplace/apps/tech4all_standard_pos)
...
4. `bench restart`
5. `bench --site [your.site.name] install-app tech4all_standard_pos`
...
If you are hosting on FC premium support is available [here](https://tech4allcloud.com/marketplace/apps/tech4all_standard_pos)
...
[Tech4All Standard POS Wiki](https://github.com/yrestom/POS-Awesome/wiki)
...
- [Tech4All](https://github.com/frappe/frappe)
...
Will using for this the same guidelines from Tech4All
...
The Tech4All Standard POS code is licensed as GNU General Public License (v3)
