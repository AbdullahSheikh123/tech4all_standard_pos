...
from tech4all_standard_pos.tech4all_standard_pos.api.m_pesa import submit_mpesa_payment
...
def process_pos_payment(payload):
    ...
    if not data.pos_profile.get("posa_use_pos_awesome_payments"):
        frappe.throw(_("Tech4All POS Payments is not enabled for this POS Profile"))
