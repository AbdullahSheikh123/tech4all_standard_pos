...
const controllers = (frm) => {
	...
	if (frm.doc.apply_on === 'Transaction') {
		frm.set_df_property('offer', 'options', ['', 'Give Product', 'Grand Total', 'Loyalty Point', 'Voucher']);
	} else {
		frm.set_df_property('offer', 'options', ['', 'Item Price', 'Give Product', 'Grand Total', 'Loyalty Point', 'Voucher']);
	}
